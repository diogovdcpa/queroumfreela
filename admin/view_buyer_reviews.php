...
<div class="page-title">
    <h1><i class="menu-icon fa fa-star"></i> Avaliação de Compradores</h1>
</div>
</div>
</div>
<div class="col-sm-8">
    ...
    <ol class="breadcrumb text-right">
        <li class="active">
            <a href="index?insert_review" class="btn btn-success">
                ...
                <i class="fa fa-plus-circle text-white"></i> <span class="text-white">Nova Avaliação</span>
...
<div class="card">
    ...
    <div class="card-header">
        ...
        Todas as avaliações de compradores
    ...
    <div class="card-body">
        ...
        Comentários de compradores (<?php echo $count_buyer_reviews; ?>)
        ...
        Comentários do vendedor (<?php echo $count_seller_reviews; ?>)
    ...
    ?>
                ...
                <tr>
                    ...
                    echo "Inserida pelo ADM  <small class='text-primary'>No Order Number</small>";

                    }else{

                    ?>

                    <a href="index?single_order=<?php echo $order_id; ?>">
                    ...
                    <a href="index?single_seller=<?php echo $review_buyer_id; ?>">
                    ...
                    <td>
                        ...
                        <a href="index?delete_buyer_review=<?php echo $review_id; ?>" onclick="return confirm('Do You Really Want To Delete This Review After Deletion Seller Rating And His Proposal Rating Will Be Also Changed.')" class="btn btn-danger">

                            <i class="fa fa-trash text-white"></i> <span class="text-white">Deletar Avaliação</span>
        ...
        <div class="d-flex justify-content-center">
            ...
            <ul class="pagination">
                ...
                echo "<li class='page-item'><a href='index?view_buyer_reviews=1' class='page-link'>Primeira Pagina</a></li>";
                ...
                echo "<li class='page-item'><a href='index?view_buyer_reviews=$total_pages' class='page-link'>Ultima Pagina </a></li>";
