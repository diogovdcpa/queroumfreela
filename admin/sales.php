...
<div class="page-header float-left">
  <div class="page-title">
    <h1><i class="menu-icon fa fa-table"></i> Contabil </h1>
  </div>
</div>
</div>
<div class="col-sm-8">
<div class="page-header float-right">
  <div class="page-title">
		<ol class="breadcrumb text-right">
		  <li class="active">Contabilidade</li>
		</ol>
  </div>
</div>
</div>
         ...
         <div class="card-header bg-primary">
             <div class="row">
                 ...
                 <div class="col-9 text-right">
                     <div class="huge"><?= $s_currency.$totalSale; ?></div>
                     Venda Total                
                 </div>
             </div>
         </div>
     ...
     <div class="card text-white border-success mb-xl-0 mb-lg-3 mb-sm-3 mb-2">
         <div class="card-header bg-success">
             <div class="row">
                 ...
                 <div class="col-9 text-right">
                     <div class="huge"><?= $s_currency.$allProfit; ?></div>
                     <div class="text-caption">Lucro Bruto</div>
                 </div>
             </div>
         </div>
      </div>    
     ...
     <div class="card text-white border-warning mb-xl-0 mb-lg-3 mb-sm-3 mb-2">
         <div class="card-header bg-warning">
             <div class="row">
                 ...
                 <div class="col-9 text-right">
                     <div class="huge"><?= $s_currency.$expenses; ?></div>
     ...
     <div class="card text-white border-danger mb-xl-0 mb-lg-3 mb-sm-3 mb-2">
         <div class="card-header bg-danger">
             <div class="row">
                 ...
                 <div class="col-9 text-right">
                     <div class="huge"><?= $s_currency.$netProfit; ?></div>
                     <div class="text-caption">Lucro Liquido</div>
                 </div>
             </div>
         </div>
    </div>    
...
<h4 class="h4">Vendas</h4>
<p class="mb-0">Contabilidade Simpificada.</p>
...
<table class="table table-bordered"><!--- table table-bordered table-hover Starts --->
	...
	<tbody><!--- tbody Starts --->
	<?php
	// $sales = $db->query("select * from sales where action!='expense'");
  ...
  $i = 0;
	...
	<td>
	<?php 
	if($sale->action == "order_completed"){
	 
   echo "Pagamento Concluido. <a class='text-primary' target='_blank' href='index?single_order=$sale->work_id'>#$order_number</a>";
	...
	<td><?= $s_currency.$sale->amount; ?></td>
	<td><?= $s_currency.$sale->processing_fee; ?></td>
	<td><?= $s_currency.$sale->profit; ?></td>
  ...
  echo "<li class='page-item'><a href='index?sales=1$filterUrl' class='page-link'>Primeira Pagina</a></li>";
  ...
  echo "<li class='page-item'><a href='index?sales=$total_pages$filterUrl' class='page-link'>Ultima Pagina </a></li>";
  ?>
  </ul>
	</div>
	</td>
	...
	<tbody>
	<tr>
  <td colspan="8" class="total-row text-right"><strong>Venda Total:</strong></td>
  <td class="total-row text-center"><?= $s_currency.$totalSale; ?></td>
  </tr>
  <tr>
  <td colspan="8" class="total-row text-right"><strong>Lucro Bruto:</strong></td>
  <td class="total-row text-center"><?= $s_currency.$allProfit; ?></td>
  </tr>
  <tr>
  <td colspan="8" class="total-row text-right"><strong>Despesas:</strong></td>
  <td class="total-row text-center"><?= $s_currency.$expenses; ?></td>
  </tr>
  <tr>
  <td colspan="8" class="total-row text-right"><strong>Lucro Liquido:</strong></td>
  <td class="total-row text-center"><?= $s_currency.$netProfit; ?></td>
  </tr>
  <tr>
  <td colspan="8" class="total-row text-right"><strong>Saldo total de compras de usuários:</strong></td>
  <td class="total-row text-center"><?= $s_currency.$shoppingBalance; ?></td>
  </tr>
	</tbody>
</table>
</div>
