...
<head>
    ...
    <meta name="description" content="Login de Usuario www.querofreela.com.br">
        ...
        <div class="container">
          ...
          <?php if(isset($_GET['session_expired'])){ ?>
            ...
            <div class="alert alert-danger mb-3 alert-dismissible fade show">
                    ...
                    <span class=" mt-3"><i class="fa  fa-1x fa-exclamation-circle"></i> Sua sessão expirou. Por favor faça login novamente!</span>
            ...
            <?php } ?>
                ...
                <input type="email" class="input form-control" value="<?php if(isset($_SESSION["r_email"])) { echo $_SESSION["r_email"]; } ?>" placeholder="Email ou Usuario" name="admin_email" >
                ...
                <input type="password" class="pass form-control" value="<?php if(isset($_SESSION["r_passoword"])) { echo $_SESSION["r_passoword"]; }else{ echo " "; } ?>" placeholder="Digite sua senha" name="admin_pass" >
                ...
                <input type="checkbox"  <?php if(isset($_SESSION["r_email"])){ ?> checked="checked" <?php } ?> name="remember"> Lembrar

                </label>

                <label class="pull-right">

                <a href="forgot-password.php">Perdeu a Senha?</a>

                </label>

                </div>

                <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30" name="admin_login">Entrar</button>
