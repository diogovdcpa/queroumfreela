            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><i class="menu-icon fa fa-star"></i> Avaliações</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"> Selecionar Proposta </label>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"> Selecionar Vendedor </label>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-3 control-label"> Atribuir Estrela </label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="review_comment" placeholder="Digite o comentario ..." rows="10"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="submit" name="insert_review" value="Salvar" class="btn btn-success form-control">
