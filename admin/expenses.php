...
<h4 class="h3">Despesas</h4>
</div><!--- card-header Ends --->
<div class="card-body"><!--- card-body Starts --->
<p class="h4">Nova Despesa</p>
<hr class="mb-1 mt-1">
<form method="post" class="mb-4">
  <div class="form-row">
    ...
    <div class="col mt-2">
    	<input type="submit" name="addExpense" class="btn btn-primary mt-4" value="Salvar">
    </div>
  </div>
</form>
...
<table class="table table-bordered"><!--- table table-bordered table-hover Starts --->	
	...
	<td><?php echo $s_currency.$expense->amount; ?></td>
	...
	<tbody>
  <tr>
  <td colspan="4" class="total-row text-right"><strong>Despesa Total:</strong></td>
  <td class="total-row text-center"><?php echo $s_currency.$expenses; ?></td>
  </tr>
	</tbody>
</table>
</div>
