...
<ul class="nav navbar-nav">
  ...
  <li class="menu-item-has-children dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Settings"> <i class="menu-icon fa fa-cog"></i> Configurações</a>
    <ul class="sub-menu children dropdown-menu">
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?general_settings">Geral</a></li>
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?layout_settings">Tema</a></li>
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?payment_settings">Pagamento</a></li>
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?mail_settings">Servidor de Email</a></li>
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?app_update">Atualização</a></li>
    </ul>
  </li>
  <li>
    <a href="index?view_proposals"> <i class="menu-icon fa fa-table"></i>Propostas / Serviços
  ...
  <li class="menu-item-has-children dropdown">
  <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cube"></i>Contabil</a>
  <ul class="sub-menu children dropdown-menu">
  <li><i class="fa  fa-arrow-circle-right"></i><a href="index?sales"> Vendas </a></li>
  <li><i class="fa  fa-arrow-circle-right"></i><a href="index?expenses"> Despesas </a></li>
  </ul>
  </li>
  <li class="menu-item-has-children dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="payouts"> 
      <i class="menu-icon fa fa-money"></i> Pagamentos
    </a>
    <ul class="sub-menu children dropdown-menu">
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?payouts&status=pending">Pendentes</a></li>
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?payouts&status=declined">Recusados</a></li>
      <li><i class="fa  fa-arrow-circle-right"></i><a href="index?payouts&status=completed">Aprovados</a></li>
    </ul>
  </li>
  <li class="menu-item-has-children dropdown">
  <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Reports"> 
    <i class="menu-icon fa fa-flag" ></i>Relatorios
  </a>
  <ul class="sub-menu children dropdown-menu">
    <li><i class="fa  fa-arrow-circle-right"></i><a href="index?order_reports">Pedidos</a></li>
    <li><i class="fa  fa-arrow-circle-right"></i><a href="index?message_reports">Mensagens</a></li>
    <li><i class="fa  fa-arrow-circle-right"></i><a href="index?proposal_reports">Propostas</a></li>
  </ul>
  </li>
  <li>
  <a href="index?inbox_conversations"> <i class="menu-icon fa fa-comments"></i>Mensagens</a>
  </li>
  <li class="menu-item-has-children dropdown">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-star"></i>Avaliações</a>
      <ul class="sub-menu children dropdown-menu">
          <li><i class="fa  fa-arrow-circle-right"></i><a href="index?insert_review">Nova Avaliação</a></li>
          <li><i class="fa  fa-arrow-circle-right"></i><a href="index?view_buyer_reviews">Exibir Avaliações</a></li>
      </ul>
  </li>
  <li>
  ...
  <li class="menu-item-has-children dropdown">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-cubes"></i>Categorias</a>
      <ul class="sub-menu children dropdown-menu">
          <li><i class="fa  fa-arrow-circle-right"></i><a href="index?insert_cat"> Nova Categoria</a></li>
          <li><i class="fa  fa-arrow-circle-right"></i><a href="index?view_cats"> Listar Categorias</a></li>
      </ul>
  </li>
  <li class="menu-item-has-children dropdown">
