            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><i class="menu-icon fa fa-cubes"></i> Categoria</h1>
                    </div>
                </div>
            </div>
...
<i class="fa fa-money-bill-alt"></i> Editar Categoria
...
<label class="col-md-3 control-label">Categoria Ativa  : </label>
...
<input type="submit" name="update_cat" value="Salvar Alterações" class="btn btn-success form-control">
