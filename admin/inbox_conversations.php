            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><i class="menu-icon fa fa-comments"></i> Mensagens</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                 ...
                 <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Todas Mensagens</h4>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered links-table">
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <tr onclick="location.href='index?single_inbox_message=<?php echo $message_group_id; ?>'">
                    ...
                    echo "<li class='page-item'><a href='index?inbox_conversations=1' class='page-link'>Primeira Pagina</a></li>";
                    ...
                    echo "<li class='page-item'><a href='index?inbox_conversations=$total_pages' class='page-link'>Ultima Pagina </a></li>";
